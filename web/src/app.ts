...
const copy: Record<Locale, Record<string, string>> = {
  "zh-CN": {
    ...
    permitDetail: "许可证详情", selectPermit: "选择一张许可证查看安全声明。", state: "状态", permitId: "许可证 ID / jti", signingKeyId: "签名密钥 ID / kid", issuer: "签发者", issuedAt: "签发时间", expiresAt: "失效时间", consumedAt: "消费时间", singleUse: "单次使用", credentialFingerprint: "委托凭据指纹", permitFormat: "签名格式", neverStored: "令牌与原始敏感参数不在此视图中保存或显示。", lifecycle: "许可证生命周期", issued: "已签发", verified: "已验证", consumed: "已消费", terminal: "终止状态", notReported: "NOT REPORTED", legacyEnvelope: "兼容授权信封；不是可独立验证的凭据",
